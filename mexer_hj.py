...
def preenche_inimigos(n, m):
    for i in range(n):
        linha = []
        for c in range(m):
            inimigo = Sprite("inimigo.png", 2)
            inimigo.set_total_duration(2000)
            inimigo.set_position(janela.width / 2 - 500 + (distancia_ini * c),
                                 janela.height * 1 / 7 + (distancia_ini * i))
...
while True:
    ...
    if state == "dificuldades":
        ...
        janela.draw_text("IMPOSSÍVEL", janela.width / 2 - Botao_jogar.width / 2 - 300,
                         janela.height / 2 - (distancia * 0) + nova_dist, tam, preto, "Calibri", True)
        janela.draw_text("DIFÍCIL", janela.width / 2 - Botao_jogar.width / 2 - 300,
                         janela.height / 2 - (distancia * 1) + nova_dist, tam, preto, "Calibri", True)
        janela.draw_text("MÉDIO", janela.width / 2 - Botao_jogar.width / 2 - 300,
                         janela.height / 2 - (distancia * 2) + nova_dist, tam, preto, "Calibri", True)
        janela.draw_text("FÁCIL", janela.width / 2 - Botao_jogar.width / 2 - 300,
                         janela.height / 2 - (distancia * 3) + nova_dist, tam, preto, "Calibri", True)
